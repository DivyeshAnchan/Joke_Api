...
app.get('/jokes/:id', (req, res) => {
  ...
  let joke = jokes.find((j) => j.id === parseInt(id))
  ...
  if (joke) {
    ...
    res.json({
      Warning: 'No Data Present for the provided id',
    })
  }
})
...
app.post('/jokes', (req, res) => {
  ...
  if (jokes[id - 1]) {
    return res.json({
      Warning: 'Joke with the specified ID already exists',
    })
  }
...
app.put('/jokes/:id', (req, res) => {
  ...
  let joke = jokes.find((j) => parseInt(j.id) === idparam)
  if (joke) {
    joke.jokeText = text
    joke.jokeType = type
    res.json({
    ...
    res.json({
      Warning: 'Value with Id Doesnt exist',
    })
  }
})
...
app.delete('/jokes/:id', (req, res) => {
  ...
  let joke = jokes.find((j) => parseInt(j.id) === parseInt(id))
...
app.delete('/all?', (req, res) => {
  ...
  if (key === masterKey) {
    jokes = []
    res.json({
      Success: 'Deleted Successfully All Data',
    })
  } else {
    res.json({
      Warning: 'Key Didnt Match',
    })
  }
})
